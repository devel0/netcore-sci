...
public partial class Vector3D : Geometry
{
    ...
    /// </summary>
    public string CadScript => PostProcessCadScript(
    ...
    /// </summary>
    public string CadScriptLineFrom => PostProcessCadScript(string.Format(CultureInfo.InvariantCulture, "_LINE {0},{1},{2}", X, Y, Z));
