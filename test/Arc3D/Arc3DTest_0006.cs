...
namespace SearchAThing.Sci.Tests
{
    public partial class Arc3DTests
    {
        ...
        public void Arc3DTest_0006()
        {
            ...
            var arcYellow = dxf.Arcs.First(w => w.Color.Index == AciColor.Yellow.Index).ToArc3D(tol);
            var arcGreen = dxf.Arcs.First(w => w.Color.Index == AciColor.Green.Index).ToArc3D(tol);
            var arcCyan = dxf.Arcs.First(w => w.Color.Index == AciColor.Cyan.Index).ToArc3D(tol);
