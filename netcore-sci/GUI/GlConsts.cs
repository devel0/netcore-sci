...
namespace SearchAThing.OpenGL
{
    public static class GlConsts
    {
        ...
        public const int GL_DYNAMIC_STORAGE_BIT_EXT = 0x100;
        public const int GL_CLIENT_STORAGE_BIT = 0x200;
        public const int GL_CLIENT_STORAGE_BIT_EXT = 0x200;
        public const int GL_SPARSE_STORAGE_BIT_ARB = 0x400;
        public const int GL_LGPU_SEPARATE_STORAGE_BIT_NVX = 0x800;
        public const int GL_PER_GPU_STORAGE_BIT_NV = 0x800;
        ...
        public const int GL_CONTEXT_FLAG_DEBUG_BIT = 0x2;
        public const int GL_CONTEXT_FLAG_DEBUG_BIT_KHR = 0x2;
        public const int GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT = 0x4;
        public const int GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT_ARB = 0x4;
        public const int GL_CONTEXT_FLAG_NO_ERROR_BIT = 0x8;
        public const int GL_CONTEXT_FLAG_NO_ERROR_BIT_KHR = 0x8;
        public const int GL_CONTEXT_FLAG_PROTECTED_CONTENT_BIT_EXT = 0x10;
        ...
        public const int GL_MAP_READ_BIT_EXT = 0x1;
        public const int GL_MAP_WRITE_BIT = 0x2;
        public const int GL_MAP_WRITE_BIT_EXT = 0x2;
        public const int GL_MAP_INVALIDATE_RANGE_BIT = 0x4;
        public const int GL_MAP_INVALIDATE_RANGE_BIT_EXT = 0x4;
        public const int GL_MAP_INVALIDATE_BUFFER_BIT = 0x8;
        public const int GL_MAP_INVALIDATE_BUFFER_BIT_EXT = 0x8;
        public const int GL_MAP_FLUSH_EXPLICIT_BIT = 0x10;
        public const int GL_MAP_FLUSH_EXPLICIT_BIT_EXT = 0x10;
        public const int GL_MAP_UNSYNCHRONIZED_BIT = 0x20;
        public const int GL_MAP_UNSYNCHRONIZED_BIT_EXT = 0x20;
        public const int GL_MAP_PERSISTENT_BIT = 0x40;
        public const int GL_MAP_PERSISTENT_BIT_EXT = 0x40;
        public const int GL_MAP_COHERENT_BIT = 0x80;
        public const int GL_MAP_COHERENT_BIT_EXT = 0x80;
        public const int GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT = 0x1;
        public const int GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT_EXT = 0x1;
        public const int GL_ELEMENT_ARRAY_BARRIER_BIT = 0x2;
        public const int GL_ELEMENT_ARRAY_BARRIER_BIT_EXT = 0x2;
        public const int GL_UNIFORM_BARRIER_BIT = 0x4;
        public const int GL_UNIFORM_BARRIER_BIT_EXT = 0x4;
        public const int GL_TEXTURE_FETCH_BARRIER_BIT = 0x8;
        public const int GL_TEXTURE_FETCH_BARRIER_BIT_EXT = 0x8;
        public const int GL_SHADER_GLOBAL_ACCESS_BARRIER_BIT_NV = 0x10;
        public const int GL_SHADER_IMAGE_ACCESS_BARRIER_BIT = 0x20;
        public const int GL_SHADER_IMAGE_ACCESS_BARRIER_BIT_EXT = 0x20;
        public const int GL_COMMAND_BARRIER_BIT = 0x40;
        public const int GL_COMMAND_BARRIER_BIT_EXT = 0x40;
        public const int GL_PIXEL_BUFFER_BARRIER_BIT = 0x80;
        public const int GL_PIXEL_BUFFER_BARRIER_BIT_EXT = 0x80;
        public const int GL_TEXTURE_UPDATE_BARRIER_BIT = 0x100;
        public const int GL_TEXTURE_UPDATE_BARRIER_BIT_EXT = 0x100;
        public const int GL_BUFFER_UPDATE_BARRIER_BIT = 0x200;
        public const int GL_BUFFER_UPDATE_BARRIER_BIT_EXT = 0x200;
        public const int GL_FRAMEBUFFER_BARRIER_BIT = 0x400;
        public const int GL_FRAMEBUFFER_BARRIER_BIT_EXT = 0x400;
        public const int GL_TRANSFORM_FEEDBACK_BARRIER_BIT = 0x800;
        public const int GL_TRANSFORM_FEEDBACK_BARRIER_BIT_EXT = 0x800;
        public const int GL_ATOMIC_COUNTER_BARRIER_BIT = 0x1000;
        public const int GL_ATOMIC_COUNTER_BARRIER_BIT_EXT = 0x1000;
        public const int GL_SHADER_STORAGE_BARRIER_BIT = 0x2000;
        public const int GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT = 0x4000;
        public const int GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT_EXT = 0x4000;
        public const int GL_QUERY_BUFFER_BARRIER_BIT = 0x8000;
        public const int GL_ALL_BARRIER_BITS = -1;
        public const int GL_ALL_BARRIER_BITS_EXT = -1;
        public const int GL_QUERY_DEPTH_PASS_EVENT_BIT_AMD = 0x1;
        public const int GL_QUERY_DEPTH_FAIL_EVENT_BIT_AMD = 0x2;
        public const int GL_QUERY_STENCIL_FAIL_EVENT_BIT_AMD = 0x4;
        public const int GL_QUERY_DEPTH_BOUNDS_FAIL_EVENT_BIT_AMD = 0x8;
        public const int GL_QUERY_ALL_EVENT_BITS_AMD = -1;
        public const int GL_SYNC_FLUSH_COMMANDS_BIT = 0x1;
        public const int GL_SYNC_FLUSH_COMMANDS_BIT_APPLE = 0x1;
        public const int GL_VERTEX_SHADER_BIT = 0x1;
        public const int GL_VERTEX_SHADER_BIT_EXT = 0x1;
        public const int GL_FRAGMENT_SHADER_BIT = 0x2;
        public const int GL_FRAGMENT_SHADER_BIT_EXT = 0x2;
        public const int GL_GEOMETRY_SHADER_BIT = 0x4;
        public const int GL_GEOMETRY_SHADER_BIT_EXT = 0x4;
        public const int GL_GEOMETRY_SHADER_BIT_OES = 0x4;
        public const int GL_TESS_CONTROL_SHADER_BIT = 0x8;
        public const int GL_TESS_CONTROL_SHADER_BIT_EXT = 0x8;
        public const int GL_TESS_CONTROL_SHADER_BIT_OES = 0x8;
        public const int GL_TESS_EVALUATION_SHADER_BIT = 0x10;
        public const int GL_TESS_EVALUATION_SHADER_BIT_EXT = 0x10;
        public const int GL_TESS_EVALUATION_SHADER_BIT_OES = 0x10;
        public const int GL_COMPUTE_SHADER_BIT = 0x20;
        public const int GL_MESH_SHADER_BIT_NV = 0x40;
        public const int GL_TASK_SHADER_BIT_NV = 0x80;
        public const int GL_ALL_SHADER_BITS = -1;
        public const int GL_ALL_SHADER_BITS_EXT = -1;
        public const int GL_SUBGROUP_FEATURE_BASIC_BIT_KHR = 0x1;
        public const int GL_SUBGROUP_FEATURE_VOTE_BIT_KHR = 0x2;
        public const int GL_SUBGROUP_FEATURE_ARITHMETIC_BIT_KHR = 0x4;
        public const int GL_SUBGROUP_FEATURE_BALLOT_BIT_KHR = 0x8;
        public const int GL_SUBGROUP_FEATURE_SHUFFLE_BIT_KHR = 0x10;
        public const int GL_SUBGROUP_FEATURE_SHUFFLE_RELATIVE_BIT_KHR = 0x20;
        public const int GL_SUBGROUP_FEATURE_CLUSTERED_BIT_KHR = 0x40;
        public const int GL_SUBGROUP_FEATURE_QUAD_BIT_KHR = 0x80;
        public const int GL_SUBGROUP_FEATURE_PARTITIONED_BIT_NV = 0x100;
        public const int GL_TEXTURE_STORAGE_SPARSE_BIT_AMD = 0x1;
        public const int GL_RED_BIT_ATI = 0x1;
        public const int GL_GREEN_BIT_ATI = 0x2;
        public const int GL_BLUE_BIT_ATI = 0x4;
        public const int GL_2X_BIT_ATI = 0x1;
        public const int GL_4X_BIT_ATI = 0x2;
        public const int GL_8X_BIT_ATI = 0x4;
        public const int GL_HALF_BIT_ATI = 0x8;
        public const int GL_QUARTER_BIT_ATI = 0x10;
        public const int GL_EIGHTH_BIT_ATI = 0x20;
        public const int GL_SATURATE_BIT_ATI = 0x40;
        public const int GL_COMP_BIT_ATI = 0x2;
        public const int GL_NEGATE_BIT_ATI = 0x4;
        public const int GL_BIAS_BIT_ATI = 0x8;
        public const int GL_TRACE_OPERATIONS_BIT_MESA = 0x1;
        public const int GL_TRACE_PRIMITIVES_BIT_MESA = 0x2;
        public const int GL_TRACE_ARRAYS_BIT_MESA = 0x4;
        public const int GL_TRACE_TEXTURES_BIT_MESA = 0x8;
        public const int GL_TRACE_PIXELS_BIT_MESA = 0x10;
        public const int GL_TRACE_ERRORS_BIT_MESA = 0x20;
        public const int GL_TRACE_ALL_BITS_MESA = 0xFFFF;
        public const int GL_BOLD_BIT_NV = 0x1;
        public const int GL_ITALIC_BIT_NV = 0x2;
        public const int GL_GLYPH_WIDTH_BIT_NV = 0x1;
        public const int GL_GLYPH_HEIGHT_BIT_NV = 0x2;
        public const int GL_GLYPH_HORIZONTAL_BEARING_X_BIT_NV = 0x4;
        public const int GL_GLYPH_HORIZONTAL_BEARING_Y_BIT_NV = 0x8;
        ...
        public const int GL_FONT_X_MIN_BOUNDS_BIT_NV = 0x10000;
        public const int GL_FONT_Y_MIN_BOUNDS_BIT_NV = 0x20000;
        public const int GL_FONT_X_MAX_BOUNDS_BIT_NV = 0x40000;
        public const int GL_FONT_Y_MAX_BOUNDS_BIT_NV = 0x80000;
        public const int GL_FONT_UNITS_PER_EM_BIT_NV = 0x100000;
        public const int GL_FONT_ASCENDER_BIT_NV = 0x200000;
        public const int GL_FONT_DESCENDER_BIT_NV = 0x400000;
        public const int GL_FONT_HEIGHT_BIT_NV = 0x800000;
        public const int GL_FONT_MAX_ADVANCE_WIDTH_BIT_NV = 0x1000000;
        public const int GL_FONT_MAX_ADVANCE_HEIGHT_BIT_NV = 0x2000000;
        public const int GL_FONT_UNDERLINE_POSITION_BIT_NV = 0x4000000;
        public const int GL_FONT_UNDERLINE_THICKNESS_BIT_NV = 0x8000000;
        public const int GL_FONT_HAS_KERNING_BIT_NV = 0x10000000;
        public const int GL_FONT_NUM_GLYPH_INDICES_BIT_NV = 0x20000000;
        public const int GL_PERFQUERY_SINGLE_CONTEXT_INTEL = 0x0;
        public const int GL_PERFQUERY_GLOBAL_CONTEXT_INTEL = 0x1;
        public const int GL_VERTEX23_BIT_PGI = 0x4;
        public const int GL_VERTEX4_BIT_PGI = 0x8;
        public const int GL_COLOR3_BIT_PGI = 0x10000;
        public const int GL_COLOR4_BIT_PGI = 0x20000;
        public const int GL_EDGEFLAG_BIT_PGI = 0x40000;
        public const int GL_INDEX_BIT_PGI = 0x80000;
        public const int GL_MAT_AMBIENT_BIT_PGI = 0x100000;
        public const int GL_MAT_AMBIENT_AND_DIFFUSE_BIT_PGI = 0x200000;
        public const int GL_MAT_DIFFUSE_BIT_PGI = 0x400000;
        public const int GL_MAT_EMISSION_BIT_PGI = 0x800000;
        public const int GL_MAT_COLOR_INDEXES_BIT_PGI = 0x1000000;
        public const int GL_MAT_SHININESS_BIT_PGI = 0x2000000;
        public const int GL_MAT_SPECULAR_BIT_PGI = 0x4000000;
        public const int GL_NORMAL_BIT_PGI = 0x8000000;
        ...
        public const int GL_COLOR_BUFFER_BIT0_QCOM = 0x1;
        public const int GL_COLOR_BUFFER_BIT1_QCOM = 0x2;
        public const int GL_COLOR_BUFFER_BIT2_QCOM = 0x4;
        public const int GL_COLOR_BUFFER_BIT3_QCOM = 0x8;
        public const int GL_COLOR_BUFFER_BIT4_QCOM = 0x10;
        public const int GL_COLOR_BUFFER_BIT5_QCOM = 0x20;
        public const int GL_COLOR_BUFFER_BIT6_QCOM = 0x40;
        public const int GL_COLOR_BUFFER_BIT7_QCOM = 0x80;
        public const int GL_DEPTH_BUFFER_BIT0_QCOM = 0x100;
        public const int GL_DEPTH_BUFFER_BIT1_QCOM = 0x200;
        public const int GL_DEPTH_BUFFER_BIT2_QCOM = 0x400;
        public const int GL_DEPTH_BUFFER_BIT3_QCOM = 0x800;
        public const int GL_DEPTH_BUFFER_BIT4_QCOM = 0x1000;
        public const int GL_DEPTH_BUFFER_BIT5_QCOM = 0x2000;
        public const int GL_DEPTH_BUFFER_BIT6_QCOM = 0x4000;
        public const int GL_DEPTH_BUFFER_BIT7_QCOM = 0x8000;
        public const int GL_STENCIL_BUFFER_BIT0_QCOM = 0x10000;
        public const int GL_STENCIL_BUFFER_BIT1_QCOM = 0x20000;
        public const int GL_STENCIL_BUFFER_BIT2_QCOM = 0x40000;
        public const int GL_STENCIL_BUFFER_BIT3_QCOM = 0x80000;
        public const int GL_STENCIL_BUFFER_BIT4_QCOM = 0x100000;
        public const int GL_STENCIL_BUFFER_BIT5_QCOM = 0x200000;
        public const int GL_STENCIL_BUFFER_BIT6_QCOM = 0x400000;
        public const int GL_STENCIL_BUFFER_BIT7_QCOM = 0x800000;
        public const int GL_MULTISAMPLE_BUFFER_BIT0_QCOM = 0x1000000;
        public const int GL_MULTISAMPLE_BUFFER_BIT1_QCOM = 0x2000000;
        public const int GL_MULTISAMPLE_BUFFER_BIT2_QCOM = 0x4000000;
        public const int GL_MULTISAMPLE_BUFFER_BIT3_QCOM = 0x8000000;
        public const int GL_MULTISAMPLE_BUFFER_BIT4_QCOM = 0x10000000;
        public const int GL_MULTISAMPLE_BUFFER_BIT5_QCOM = 0x20000000;
        public const int GL_MULTISAMPLE_BUFFER_BIT6_QCOM = 0x40000000;
        public const uint GL_MULTISAMPLE_BUFFER_BIT7_QCOM = 0x80000000;
        public const int GL_FOVEATION_ENABLE_BIT_QCOM = 0x1;
        public const int GL_FOVEATION_SCALED_BIN_METHOD_BIT_QCOM = 0x2;
        public const int GL_FOVEATION_SUBSAMPLED_LAYOUT_METHOD_BIT_QCOM = 0x4;
        public const int GL_TEXTURE_DEFORMATION_BIT_SGIX = 0x1;
        public const int GL_GEOMETRY_DEFORMATION_BIT_SGIX = 0x2;
        // VENDOR: NV
        // For NV_command_list.
        public const int GL_TERMINATE_SEQUENCE_COMMAND_NV = 0x0;
        public const int GL_NOP_COMMAND_NV = 0x1;
        public const int GL_DRAW_ELEMENTS_COMMAND_NV = 0x2;
        public const int GL_DRAW_ARRAYS_COMMAND_NV = 0x3;
        public const int GL_DRAW_ELEMENTS_STRIP_COMMAND_NV = 0x4;
        public const int GL_DRAW_ARRAYS_STRIP_COMMAND_NV = 0x5;
        public const int GL_DRAW_ELEMENTS_INSTANCED_COMMAND_NV = 0x6;
        public const int GL_DRAW_ARRAYS_INSTANCED_COMMAND_NV = 0x7;
        public const int GL_ELEMENT_ADDRESS_COMMAND_NV = 0x8;
        public const int GL_ATTRIBUTE_ADDRESS_COMMAND_NV = 0x9;
        public const int GL_UNIFORM_ADDRESS_COMMAND_NV = 0xA;
        public const int GL_BLEND_COLOR_COMMAND_NV = 0xB;
        public const int GL_STENCIL_REF_COMMAND_NV = 0xC;
        public const int GL_LINE_WIDTH_COMMAND_NV = 0xD;
        public const int GL_POLYGON_OFFSET_COMMAND_NV = 0xE;
        public const int GL_ALPHA_REF_COMMAND_NV = 0xF;
        public const int GL_VIEWPORT_COMMAND_NV = 0x10;
        public const int GL_SCISSOR_COMMAND_NV = 0x11;
        public const int GL_FRONT_FACE_COMMAND_NV = 0x12;
        // VENDOR: INTEL
        // Texture memory layouts for INTEL_map_texture
        public const int GL_LAYOUT_DEFAULT_INTEL = 0x0;
        public const int GL_LAYOUT_LINEAR_INTEL = 0x1;
        public const int GL_LAYOUT_LINEAR_CPU_CACHED_INTEL = 0x2;
        // VENDOR: NV
        public const int GL_CLOSE_PATH_NV = 0x0;
        public const int GL_MOVE_TO_NV = 0x2;
        public const int GL_RELATIVE_MOVE_TO_NV = 0x3;
        public const int GL_LINE_TO_NV = 0x4;
        public const int GL_RELATIVE_LINE_TO_NV = 0x5;
        public const int GL_HORIZONTAL_LINE_TO_NV = 0x6;
        public const int GL_RELATIVE_HORIZONTAL_LINE_TO_NV = 0x7;
        public const int GL_VERTICAL_LINE_TO_NV = 0x8;
        public const int GL_RELATIVE_VERTICAL_LINE_TO_NV = 0x9;
        public const int GL_QUADRATIC_CURVE_TO_NV = 0xA;
        public const int GL_RELATIVE_QUADRATIC_CURVE_TO_NV = 0xB;
        public const int GL_CUBIC_CURVE_TO_NV = 0xC;
        public const int GL_RELATIVE_CUBIC_CURVE_TO_NV = 0xD;
        public const int GL_SMOOTH_QUADRATIC_CURVE_TO_NV = 0xE;
        public const int GL_RELATIVE_SMOOTH_QUADRATIC_CURVE_TO_NV = 0xF;
        ...
        // VENDOR: SUN
        public const int GL_RESTART_SUN = 0x1;
        public const int GL_REPLACE_MIDDLE_SUN = 0x2;
        public const int GL_REPLACE_OLDEST_SUN = 0x3;
        // VENDOR: ARB
        ...
        public const int GL_NONE_OES = 0x0;
        ...
        public const int GL_TIMEOUT_IGNORED = -1;
        public const int GL_TIMEOUT_IGNORED_APPLE = -1;
        ...
        public const int GL_UUID_SIZE_EXT = 0x10;
        public const int GL_LUID_SIZE_EXT = 0x8;
        // VENDOR: ARB
        ...
        public const int GL_QUADS_EXT = 0x7;
        public const int GL_QUADS_OES = 0x7;
        ...
        public const int GL_LINES_ADJACENCY_EXT = 0xA;
        public const int GL_LINES_ADJACENCY_OES = 0xA;
        public const int GL_LINE_STRIP_ADJACENCY = 0xB;
        public const int GL_LINE_STRIP_ADJACENCY_ARB = 0xB;
        public const int GL_LINE_STRIP_ADJACENCY_EXT = 0xB;
        public const int GL_LINE_STRIP_ADJACENCY_OES = 0xB;
        public const int GL_TRIANGLES_ADJACENCY = 0xC;
        public const int GL_TRIANGLES_ADJACENCY_ARB = 0xC;
        public const int GL_TRIANGLES_ADJACENCY_EXT = 0xC;
        public const int GL_TRIANGLES_ADJACENCY_OES = 0xC;
        public const int GL_TRIANGLE_STRIP_ADJACENCY = 0xD;
        public const int GL_TRIANGLE_STRIP_ADJACENCY_ARB = 0xD;
        public const int GL_TRIANGLE_STRIP_ADJACENCY_EXT = 0xD;
        public const int GL_TRIANGLE_STRIP_ADJACENCY_OES = 0xD;
        public const int GL_PATCHES = 0xE;
        public const int GL_PATCHES_EXT = 0xE;
        public const int GL_PATCHES_OES = 0xE;
        ...
        public const int GL_SRC_ALPHA_SATURATE_EXT = 0x308;
        ...
        public const int GL_STACK_OVERFLOW_KHR = 0x503;
        public const int GL_STACK_UNDERFLOW = 0x504;
        public const int GL_STACK_UNDERFLOW_KHR = 0x504;
        public const int GL_OUT_OF_MEMORY = 0x505;
        public const int GL_INVALID_FRAMEBUFFER_OPERATION = 0x506;
        public const int GL_INVALID_FRAMEBUFFER_OPERATION_EXT = 0x506;
        public const int GL_INVALID_FRAMEBUFFER_OPERATION_OES = 0x506;
        public const int GL_CONTEXT_LOST = 0x507;
        public const int GL_CONTEXT_LOST_KHR = 0x507;
        ...
        public const int GL_POLYGON_MODE_NV = 0xB40;
        ...
        public const int GL_MODELVIEW0_STACK_DEPTH_EXT = 0xBA3;
        public const int GL_PATH_MODELVIEW_STACK_DEPTH_NV = 0xBA3;
        public const int GL_PROJECTION_STACK_DEPTH = 0xBA4;
        public const int GL_PATH_PROJECTION_STACK_DEPTH_NV = 0xBA4;
        public const int GL_TEXTURE_STACK_DEPTH = 0xBA5;
        public const int GL_MODELVIEW_MATRIX = 0xBA6;
        public const int GL_MODELVIEW0_MATRIX_EXT = 0xBA6;
        public const int GL_PATH_MODELVIEW_MATRIX_NV = 0xBA6;
        public const int GL_PROJECTION_MATRIX = 0xBA7;
        public const int GL_PATH_PROJECTION_MATRIX_NV = 0xBA7;
        ...
        public const int GL_ALPHA_TEST_QCOM = 0xBC0;
        public const int GL_ALPHA_TEST_FUNC = 0xBC1;
        public const int GL_ALPHA_TEST_FUNC_QCOM = 0xBC1;
        public const int GL_ALPHA_TEST_REF = 0xBC2;
        public const int GL_ALPHA_TEST_REF_QCOM = 0xBC2;
        ...
        public const int GL_DRAW_BUFFER_EXT = 0xC01;
        public const int GL_READ_BUFFER = 0xC02;
        public const int GL_READ_BUFFER_EXT = 0xC02;
        public const int GL_READ_BUFFER_NV = 0xC02;
        ...
        public const int GL_UNPACK_ROW_LENGTH_EXT = 0xCF2;
        public const int GL_UNPACK_SKIP_ROWS = 0xCF3;
        public const int GL_UNPACK_SKIP_ROWS_EXT = 0xCF3;
        public const int GL_UNPACK_SKIP_PIXELS = 0xCF4;
        public const int GL_UNPACK_SKIP_PIXELS_EXT = 0xCF4;
        ...
        public const int GL_MAX_CLIP_PLANES_IMG = 0xD32;
        public const int GL_MAX_CLIP_DISTANCES = 0xD32;
        public const int GL_MAX_CLIP_DISTANCES_EXT = 0xD32;
        public const int GL_MAX_CLIP_DISTANCES_APPLE = 0xD32;
        ...
        public const int GL_PATH_MAX_MODELVIEW_STACK_DEPTH_NV = 0xD36;
        public const int GL_MAX_NAME_STACK_DEPTH = 0xD37;
        public const int GL_MAX_PROJECTION_STACK_DEPTH = 0xD38;
        public const int GL_PATH_MAX_PROJECTION_STACK_DEPTH_NV = 0xD38;
        ...
        public const int gles2_GL_ACTIVE_PROGRAM_EXT = 0x8259;
        ...
        public const int gl_GL_ACTIVE_PROGRAM_EXT = 0x8B8D;
        // VENDOR: OES
        ...
        public const int GL_MOTION_ESTIMATION_SEARCH_BLOCK_X_QCOM = 0x8C90;
        public const int GL_MOTION_ESTIMATION_SEARCH_BLOCK_Y_QCOM = 0x8C91;
        ...
        public const int GL_TEXTURE_UNNORMALIZED_COORDINATES_ARM = 0x8F6A;
        // VENDOR: HI
        ...
        public const int GL_SHADING_RATE_QCOM = 0x96A4;
        public const int GL_SHADING_RATE_PRESERVE_ASPECT_RATIO_QCOM = 0x96A5;
        public const int GL_SHADING_RATE_1X1_PIXELS_QCOM = 0x96A6;
        public const int GL_SHADING_RATE_1X2_PIXELS_QCOM = 0x96A7;
        public const int GL_SHADING_RATE_2X1_PIXELS_QCOM = 0x96A8;
        public const int GL_SHADING_RATE_2X2_PIXELS_QCOM = 0x96A9;
        public const int GL_SHADING_RATE_1X4_PIXELS_QCOM = 0x96AA;
        public const int GL_SHADING_RATE_4X1_PIXELS_QCOM = 0x96AB;
        public const int GL_SHADING_RATE_4X2_PIXELS_QCOM = 0x96AC;
        public const int GL_SHADING_RATE_2X4_PIXELS_QCOM = 0x96AD;
        public const int GL_SHADING_RATE_4X4_PIXELS_QCOM = 0x96AE;
        // VENDOR: ANGLE
        // github pull request
        // VENDOR: ARM
